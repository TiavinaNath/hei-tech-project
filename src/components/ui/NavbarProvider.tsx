...
export default function NavbarProvider() {
  ...
  const links = [
    { href: '/provider/dashboard', label: 'Mes demandes', icon: <ClipboardList className="w-4 h-4" /> },
    { href: '/provider/dashboard/messages', label: 'Messagerie', icon: <MessageCircle className="w-4 h-4" /> },
    { href: '/provider/dashboard/account', label: 'Compte', icon: <User className="w-4 h-4" /> },
  ];
